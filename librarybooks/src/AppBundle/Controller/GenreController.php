...
class GenreController extends Controller
{
    ...
    {
        $genre = new Genre();
        $form = $this->createForm('AppBundle\Form\GenreEditType', $genre);
    ...
    {
        $deleteForm = $this->createDeleteForm($genre);
        $editForm = $this->createForm('AppBundle\Form\GenreEditType', $genre);
    ...
    public function deleteAction(Request $request, Genre $genre)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
              ...
              $this->addFlash(
                'notice',
                'Some book have this genre, you cant delete it'
              );
            }
        }
